...
// constructor
	...
	// Check values
		...
		$social_stackoverflow_link  = isset( $instance['social_stackoverflow_link'] ) ? esc_url( $instance['social_stackoverflow_link'] ) : '';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id( 'social_url_path' )); ?>"><?php esc_html_e( 'Check this box to open links in a new window.', 'hired' ); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_snapchat_link')); ?>"><?php esc_html_e('Snapchat URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vine_link')); ?>"><?php esc_html_e('Vine URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_stumble_link')); ?>"><?php esc_html_e('StumbleUpon URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_yelp_link')); ?>"><?php esc_html_e('Yelp URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vk_link')); ?>"><?php esc_html_e('VK URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_xing_link')); ?>"><?php esc_html_e('Xing URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_deviant_link')); ?>"><?php esc_html_e('DeviantArt URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_500_link')); ?>"><?php esc_html_e('500px URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_behance_link')); ?>"><?php esc_html_e('Behance URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_lastfm_link')); ?>"><?php esc_html_e('lastFM URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_soundcloud_link')); ?>"><?php esc_html_e('SoundCloud URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_reddit_link')); ?>"><?php esc_html_e('Reddit URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_codepen_link')); ?>"><?php esc_html_e('CodePen URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_skype_link')); ?>"><?php esc_html_e('Skype URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_spotify_link')); ?>"><?php esc_html_e('Spotify URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_weibo_link')); ?>"><?php esc_html_e('Weibo URL:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_stackoverflow_link')); ?>"><?php esc_html_e('Stack Overflow URL:', 'hired'); ?></label>

	<input class="widefat" id="<?php echo sanitize_text_field( $this->get_field_id('social_stackoverflow_link')); ?>" name="<?php echo sanitize_text_field( $this->get_field_name('social_stackoverflow_link')); ?>" type="text" value="<?php echo esc_url( $social_stackoverflow_link ); ?>" /> 
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_email_link')); ?>"><?php esc_html_e('Email Address:', 'hired'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_telephone_link')); ?>"><?php esc_html_e('Phone Number:', 'hired'); ?></label>
	...
	function update($new_instance, $old_instance) { 
		...
		$instance['social_stackoverflow_link']  = 	esc_url_raw($new_instance['social_stackoverflow_link']); 
...
?>
    	...
    	<ul class='social-media-icons'>
			...
			<?php endif; ?>
            <?php if ($social_stackoverflow_link !='') : ?>
            	<li>
                <a href="<?php echo esc_url( $social_stackoverflow_link ); ?>" <?php if( $social_url_path ) : ?>target="_blank"<?php endif; ?>>
